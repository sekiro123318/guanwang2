    ...
    const render = () => {
      ...
      for (let i = 0; i < numPoints; i++) {
        ...
        helixPoints.push({
          ...
          y: y1,
          z: z1,
          color: `rgba(6, 182, 212, ${0.6 + Math.sin(time * 0.002 + i) * 0.2})`,
          radius: 4 * pulse
        })
        ...
        helixPoints.push({
          ...
          y: y2,
          z: z2,
          color: `rgba(139, 92, 246, ${0.6 + Math.cos(time * 0.002 + i) * 0.2})`,
          radius: 4 * pulse
        })
        ...
        if (i < numPoints - 1) {
          ...
          helixPoints.push({
            ...
            y: (y1 + y2) / 2,
            z: (z1 + z2) / 2,
            color: `rgba(236, 72, 153, ${0.4 + Math.sin(time * 0.004 + i) * 0.15})`,
            radius: 2.5 * pulse
          })
        }
      }
      ...
      for (let i = 0; i < numHelixPoints - 1; i++) {
        ...
        ctx.strokeStyle = `rgba(255, 255, 255, ${0.15 + Math.sin(time * 0.003 + i) * 0.1})`
      ...
      particles.forEach((particle) => {
        ...
        if (Math.abs(particle.z) > 200) particle.vz *= -1
        ...
        ctx.fillStyle = particle.color.replace(/[\d.]+\)$/, `${particle.alpha + mouseEffect * 0.3})`)
        ctx.fill()
        ...
        if (mouseEffect > 0.3) {
          ...
          glowGradient.addColorStop(0, particle.color.replace(/[\d.]+\)$/, `${mouseEffect * 0.2})"))
          glowGradient.addColorStop(1, "rgba(0, 0, 0, 0)")
          ctx.fillStyle = glowGradient
          ctx.fill()
        }
