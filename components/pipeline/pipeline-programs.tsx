  ...
  return (
    <div className="flex items-center gap-0 w-full overflow-x-auto pb-2">
      {stageKeys.map((key, i) => {
        ...
        return (
          <div key={key} className="flex flex-1 items-center min-w-max">
            <div className="flex flex-col items-center gap-1.5 flex-1 min-w-[60px]">
              ...
              <span
                className={cn(
                  "text-[10px] font-medium text-center leading-tight sm:text-xs break-words px-1",
...
function ProgramCard({
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-6 transition-shadow hover:shadow-lg min-w-0">
      {/* Header */}
      <div className="flex flex-col gap-1 mb-6 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0 flex-1">
          <h3 className="text-base font-semibold text-foreground sm:text-lg break-words">
            {t(program.nameKey)}
          </h3>
          {program.classKey && (
        ...
        <span className="text-sm font-medium text-muted-foreground whitespace-nowrap sm:ml-4">
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between text-xs text-muted-foreground mb-1.5">
          <span>{t("pipeline.researchProgress")}</span>
