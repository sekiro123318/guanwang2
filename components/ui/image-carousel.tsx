...
export const carouselImages = [
  { src: "/pipeline/1.jpg", alt: "Pipeline Image 1 - Wet and dry experiments with AI prediction results match" },
  { src: "/pipeline/2.png", alt: "Pipeline Image 2 - Wet and dry experiments with AI prediction results match" },
  { src: "/pipeline/3.png", alt: "Pipeline Image 3 - Wet and dry experiments with AI prediction results match" },
  { src: "/pipeline/4.png", alt: "Pipeline Image 4 - Wet and dry experiments with AI prediction results match" },
  { src: "/pipeline/5.png", alt: "Pipeline Image 5 - Wet and dry experiments with AI prediction results match" },
  { src: "/pipeline/6.png", alt: "Pipeline Image 6 - Wet and dry experiments with AI prediction results match" },
  { src: "/pipeline/7.jpg", alt: "Pipeline Image 7 - Wet and dry experiments with AI prediction results match" },
]
