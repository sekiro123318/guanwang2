...
export const carouselImages = [
  { src: "/images/carousel/cell-microscopy.jpg", alt: "Cell Microscopy - Advanced cellular imaging for drug discovery" },
  { src: "/images/carousel/dna-helix.jpg", alt: "DNA Helix - Genetic research and molecular biology" },
  { src: "/images/carousel/drug-receptor.jpg", alt: "Drug Receptor - Molecular interactions and binding studies" },
